...
OPTIONS:
  ...
  --native-host HOST      Sets the host of the underlying WebDriver (Linux/macOS)
  --native-driver PATH    Sets the path to the native WebDriver binary (Linux/Windows)
                          or WebDriverAgentMac project directory (macOS, required)
";
